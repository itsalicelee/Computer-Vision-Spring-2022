...
def build_vocabulary(image_paths, vocab_size):
    ...
    for path in image_paths:
        ...
        # random_descriptors = random.sample(list(descriptors), len(descriptors)//2)
        # vocab.append(random_descriptors)
        i = 0
    ...
    # print(vocab)
    print("vocab shape: ", np.matrix(vocab).shape)
    # vocab = np.reshape(vocab, (-1, 128))
    mat = np.matrix(vocab).astype('float32')
    vocab = kmeans(mat, vocab_size)
    print("Done of building vocabulary!")
